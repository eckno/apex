...
<!-- Mirrored from themeturn.com/tf-db/bitbank/bitbank/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Jul 2023 09:42:39 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <title>Using Apex Holdings | Apex Holdings</title>
        ...
        <div class="hero-container container">
            <div class="hero-content">
                <div class="col-sm-12 m-auto text-center white">
                    <h3 class="h1-md mb10 text-uppercase">Using Apex Holdings</h3>
                    <h4 class="subheading">Learn/Using Apex Holdings</h4>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="heading m-auto text-center ">
                    <h2 class="f-xbold">Learn how to use Apex Holdings’s learning platforms</h2>
                    <hr class="seperator">
                    <p>Experience the power of Apex Holdings' trading platforms through 
                        a quick tour and unlock valuable features and benefits that await you.</p>
                </div>
            </div>
            <div class="row mb50">
                <div class="col-md-4 col-sm-4">
                    <div class="feature-box">
                        <div class="feature-inner">
                            <h4>Apex Holdings Mobile</h4>
                            <p>LTap into stocks, options, and futures trading while on the move with Apex Holdings’s mobile apps.</p>
                            <a href="mobile.php" class="read-more">Introduction</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4">
                    <div class="feature-box">
                        <div class="feature-inner">
                            <h4>Apex Holdings Web</h4>
                            <p>Connect to the stock, options, and futures markets from your
                                 browser with Apex Holdings Web Trading.</p>
                            <a href="web.php" class="read-more">Introduction</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4">
                    <div class="feature-box">
                        <div class="feature-inner">
                            <h4>Apex Holdings Desktop</h4>
                            <p>Trade stocks, options, and futures like a pro with Apex Holdings’s full-featured desktop platform.</p>
                            <a href="desktop.php" class="read-more">Introduction</a>
                        </div>
                    </div>
                </div>
            </div>
...
<section id="features" class="bg-gray section-padding">
        <div class="container">
            <div class="row">
                <div class="heading m-auto text-center ">
                    <h2 class="f-xbold">Learn how to manage your accounts</h2>
                    <hr class="seperator">
                    <p>Apex Holdings makes it a snap to manage your accounts and access your important information.</p>
                </div>
            </div>
            <div class="row mb50">
                <div class="col-md-4 col-sm-4">
                    <div class="feature-box">
                        <div class="feature-inner">
                            <h4>Equities Account Management</h4>
                            <p>Learn the essentials and find answers to popular equities account questions here.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4">
                    <div class="feature-box">
                        <div class="feature-inner">
                            <h4>Futures Account Management</h4>
                            <p>Learn the essentials and find answers to popular futures account questions here.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4">
                    <div class="feature-box">
                        <div class="feature-inner">
                            <h4>Crypto Account Management</h4>
                            <p>Learn the essentials and find answers to popular crypto account questions here.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<section id="features" class="bg-gray section-padding">
        <div class="container">
            <div class="row">
                <div class="heading m-auto text-center ">
                    <h2 class="f-xbold">In-depth Apex Holdings Platform Training</h2>
                    <hr class="seperator">
                    <p>Apex Holdings also hosts channels on YouCanTrade to help you get started. Get to learn about many 
                        of the powerful functions and features Apex Holdings offers through its online tools.</p>
                </div>
            </div>
            <div class="row">
                 <div class="col-md-6 col-sm-6">
                    <div class="feature-box">
                        <div class="feature-inner">
                            <h4>Getting Started with Apex Holdings</h4>
                            <p>If you're looking to familiarize yourself with Apex Holdings's platforms swiftly,
                                 we offer comprehensive resources to help you get up to speed. Learn how to efficiently
                                  set up your trading tools and charts, effectively search for trading opportunities, 
                                  execute orders, and manage your account. Gain valuable insights by watching live demos
                                   led by our product experts, featuring real-time data. These demos are designed to provide 
                                you with practical knowledge and a hands-on understanding of our platforms.</p>
                            <a href="" class="read-more">Visit Channel</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="feature-box">
                        <div class="feature-inner">
                            <h4>Apex Holdings Master Class</h4>
                            <p>Are you ready to take your Apex Holdings experience to the next level? Enhance your 
                                expertise in charting, scanning, advanced order entry tools, and other powerful features. 
                                Expand your capabilities by learning how to customize indicators and strategies according 
                                to your preferences. With this knowledge, you'll be able to leverage Apex Holdings to trade 
                                in a manner that aligns perfectly with your unique trading style and goals.
                                 Empower yourself to trade the way you've always envisioned with Apex Holdings.</p>
                            <a href="" class="read-more">Visit Channel</a>
                        </div>
                    </div>
                </div>
    ...
    <footer id="footer-main">
        <div class="container">
            ...
            <div class="col-md-12 text-center">
                    <p class="copy ">Apex Holdings Group, Inc. is the parent company of wholly owned subsidiaries, 
                        including Apex Holdings Securities, Inc., Apex Holdings Crypto, Inc., and Apex Holdings Technologies, 
                        Inc. All these subsidiaries operate under the Apex Holdings brand and trademark, offering various 
                        products and services. Additionally, You Can Trade, Inc. is another wholly owned subsidiary of Apex 
                        Holdings Group, Inc. and operates under its own brand and trademarks. It is crucial to be aware of
                         the specific company you will be dealing with when applying
                         for or purchasing accounts, subscriptions, products, and services.</p>
                </div>
                <div class="col-md-12 text-center">
    ...
    <!-- Start Back To Top -->
    <a data-scroll id="back-to-top" href="#about-page"><i class="icon ion-chevron-up"></i></a>
    <!-- End Back To Top -->
