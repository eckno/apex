...
<head>
    ...
    <title>TSCrypto | Apex Holdings</title>
        ...
        <div class="hero-container container">
            <div class="hero-content">
                <div class="col-sm-12 m-auto text-center white">
                    <h3 class="h1-md mb10 text-uppercase">TSCrypto</h3>
                    <h4 class="subheading">Platform and Tools/TSCrypto</h4>
                </div>
            </div>
        </div>
    </section>
...
<section id="features" class="bg-gray ">
        <div class="container">
            <div class="row">
                <div class="heading">
                    ...
                    <h2 class="f-xbold">TSCrypto is designed for crypto traders</h2>
                    <p>Technology that is powerful yet simplistic.</p>
                </div>
            </div>
        </div>
    </section>
 ...
 <section id="features" class="bg-gray ">
        <div class="container">
            <div class="row mb50">
            <p>Simple, powerful, and easy to use platform packed with opportunity-finding 
                and market-seizing tools and features. All in our award-winning platform, TSCrypto.</p>
                    <div class="feature-box">
                        <div class="feature-inner">
                            <h4>Customizable Trading Interface</h4>
                            <p>Trade your way with a customizable user 
                                interface that lets you personalize your terminal
                                 to match your trading style.</p>
                        </div>
                    </div>
                    ...
                    <div class="feature-box">
                        <div class="feature-inner">
                            <h4>One-click order entry</h4>
                            <p>Point and shoot order interfaces let you quickly get your orders into the market.</p>
                        </div>
                    </div>
                    ...
                    <div class="feature-box">
                        <div class="feature-inner">
                            <h4>Crypto Positions and P&L</h4>
                            <p>Instantly know your unrealized profit and loss through your crypto position manager.</p>
                        </div>
                    </div>
                    ...
                    <div class="feature-box">
                        <div class="feature-inner">
                            <h4>Advanced charting and real time data</h4>
                            <p>Spot trends and apply technical analysis to your favorite crypto pairs.</p>
 ...
 <section id="features" class="bg-gray ">
        <div class="container">
            <div class="row mb50">
                    ...
                    <div class="feature-box">
                        <div class="feature-inner">
                            <h4>Interest Earnings</h4>
                            <p>Easily keep track of your interest income
                                 and monitor the latest available interest rates in one simple tool.</p>
                                 <a href="index.php" class="read-more">Learn More</a>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row mb50">
                    ...
                    <div class="feature-box">
                        <div class="feature-inner">
                            <h4>Dealings</h4>
                            <p>Get instant access to the quick trade bar in your customized 
                                trade room to set the price and order type to easily buy or sell crypto.</p>
                        </div>
                    </div>
 ...
 <section id="features" class="bg-gray ">
        <div class="container">
            <div class="row mb50">
                    ...
                    <div class="feature-box">
                        <div class="feature-inner">
                            <h4>Consolidated Orderbook</h4>
                            <p>Quickly analyze prices, spot arbitrage opportunities, and view multiple levels of market 
                                depth across all our connected markets in a single real-time view.</p>
                                 <a href="signup.php" class="read-more">Open Account</a>
                        </div>
                    </div>
 ...
 <section id="features" class="bg-gray ">
        <div class="container">
            <div class="row mb50">
                    ...
                    <div class="feature-box">
                        <div class="feature-inner">
                            <h4>Auto-limit prices</h4>
                            <p>Join the bid, take the offer, and much more with dynamic 
                                limit prices that are set based on the current market prices.</p>
                        </div>
                    </div>
 ...
 <section id="features" class="bg-gray ">
        <div class="container">
            <div class="row mb50">
                    ...
                    <div class="feature-box">
                        <div class="feature-inner">
                            <h4>Withdrawals and Deposits</h4>
                            <p>Freedom to withdraw crypto without any fees and enjoy
                                 near-instant access to your crypto deposits for trading.</p>
                                 <a href="index.php" class="read-more">Learn More</a>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                 <div class="col-md-12 col-sm-12">
                    <div class="feature-box">
                        <div class="feature-inner">
                            <h4>Your mobile phone is more powerful than the computer that put Apollo 11 on the moon.</h4>
                                <p >
                                Get the power and reliability of TSCrypto on the go, available in
                                 the Apex Holdings mobile app. Download the mobile app now to trade cryptocurrencies, 
                                track positions, manage orders and optimize your interest earnings.
                                </p>

                                <p >
                                Launch Apex Holdings wherever you are.
                                </p>
                          </br>
                          </br>
                          <p>Crypto investment and trading are offered by Apex Holdings Crypto, Inc.
                             Apex Holdings Crypto, Inc.’s NMLS ID number is 1843762.</p>
                        </div>
                    </div>
                </div>
