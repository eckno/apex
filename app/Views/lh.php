...
<head>
    ...
    <title>Learn | Apex Holdings</title>
        ...
        <div class="hero-container container">
            <div class="hero-content">
                <div class="col-sm-12 m-auto text-center white">
                    <h3 class="h1-md mb10 text-uppercase">Learn</h3>
                    <h4 class="subheading">Learn/Learn Home</h4>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="heading m-auto text-center ">
                    <h2 class="f-xbold">Let’s get started!</h2>
                    <hr class="seperator">
                    <p>Whether you are a novice trader, new to Apex Holdings, or seeking to maximize the potential 
                        of our robust analysis and trading tools, 
                        we offer a wide range of resources to support your learning journey at your own pace.</p>
                </div>
            </div>
            <div class="row mb50">
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="feature-box">
                        <div class="feature-inner">
                            <h4>Using Apex Holdings</h4>
                            <p>Learn how to harness the full potential of Apex Holdings’s trading platforms and mobile apps.</p>
                            <a href="overview1.php" class="read-more">Read More</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4">
                    <div class="feature-box">
                        <div class="feature-inner">
                            <h4>FAQs</h4>
                            <p>Find answers to FAQs about Apex Holdings services, platforms, technology and education.</p>
                            <a href="faqs.php" class="read-more">Find Answers</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="col-sm-8 text-center m-auto pt100 pb100 border-top">
                <div class="white text-center parallax-info">
                    <h1 class="mb10 lspacing">Ready to up your trading game?</h1>
                    <h4>Find a trading coach who’s right for you.</h4>
                  <p>Trading is a skill that can be learned by anyone, 
                    regardless of their background or experience. Whether 
                    you are entirely new to the world of investing or a seasoned
                     trader, there is always an opportunity for personal growth 
                     and development in the trading arena.</p>
                     <p>Find out how the experienced trading coaches of YouCanTrade can help. </P>
