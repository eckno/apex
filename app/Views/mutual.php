...
<head>
    ...
    <title>Mutual Funds | Apex Holdings</title>
        ...
        <div class="hero-container container">
            <div class="hero-content">
                <div class="col-sm-12 m-auto text-center white">
                    <h3 class="h1-md mb10 text-uppercase">Mutual Funds</h3>
                    <h4 class="subheading">Trading Products/Mutual Funds</h4>
                </div>
            </div>
        </div>
    </section>
...
<section id="features" class="bg-gray ">
    <br/>
        ...
        <div class="container">
            <div class="row">
                <div class="heading ">
                    <h2 class="f-xbold">Mutual Funds</h2>
                   
                    <p>Gain access to Mutual Funds through Apex Holdings</p>
                </div>
        </div>
        </div>
    </section>
 ...
 <section id="features" class="bg-gray ">
        ...
        <div class="row">
                <div class=" ">
                    <h4 class="f-xbold">Advantages of Trading Mutual Funds</h4>
                    <p>Mutual Funds can provide you with a great way to diversify your portfolio.</p>
                   </br>
                    <p><b>Deep selection of Mutual Funds. </b>Choose among more than 2,000 mutual funds.</p>
                    <p><b>Expertise. </b>Invest with well-known fund managers and benefit from their experience.</p>
                    <p><b>Diversification. </b>Look to mutual funds to diversify your portfolio and manage risk.</p>
                </div>
            </div>
            </br>
                     </br>
        ...
        <div class="container">
            <div class="col-sm-8 text-center m-auto pt100 pb100 border-top">
                <div class="white text-center parallax-info">
                    <h1 class="mb10 lspacing">Simplify your investment decisions by adding mutual funds to your Apex Holdings account.</h1>
