...
<head>
    ...
    <title>Futures Option | Apex Holdings</title>
        ...
        <div class="hero-container container">
            <div class="hero-content">
                <div class="col-sm-12 m-auto text-center white">
                    <h3 class="h1-md mb10 text-uppercase">Futures Option</h3>
                    <h4 class="subheading">Trading Products/Futures Option</h4>
                </div>
            </div>
        </div>
    </section>
...
<section id="features" class="bg-gray section-padding">
        <div class="container">
            <div class="row">
                <div class="heading ">
                    <h2 class="f-xbold">Futures Options</h2>
                   
                    <p>Boost your futures trading today with FuturesPlus</p>
                </div>
        </div>
        </div>
    </section>
 ...
 <section id="features" class="bg-gray ">
        ...
        <div class="row">
                <div class=" ">
                    <h4 class="f-xbold">Advantages of Trading Futures Options</h4>
                   </br>
                    <p><b>Diversify. </b>Access to trading opportunities in over 250 futures option products.</p>
                    <p><b>Manage risk. </b>Deploy futures options strategies to benefit from directional or 
                    neutral outlooks or volatility expansions with managed risk</p>
                    <p><b>We have extended trading hours. </b>Unlike stock options, futures options have extended trading hours so you can trade around the clock.</p>
                    <p><b>Attain leverage. </b>Because options are a leveraged product, trading futures options may help you achieve a higher rate of return under the right conditions.</p>
                </div>
            </div>
            </br>
                     </br>
        ...
        <div class="container">
            <div class="col-sm-8 text-center m-auto pt100 pb100 border-top">
                <div class="white text-center parallax-info">
                    <h1 class="mb10 lspacing">Don’t wait! Take FuturesPlus for a spin today.</h1>
