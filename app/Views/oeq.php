...
<head>
    ...
    <title>Order Execution Quality & Reliability | Apex Holdings</title>
        ...
        <div class="hero-container container">
            <div class="hero-content">
                <div class="col-sm-12 m-auto text-center white">
                    <h3 class="h1-md mb10 text-uppercase">Order Execution Quality & Reliability</h3>
                    <h4 class="subheading">Platform and Tools/Order Execution Quality & Reliability</h4>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="heading">
                    ...
                    <h3 class="f-xbold">Get fast, reliable order execution</h3>
                    <p>Apex Holdings delivers fast, reliable order execution for our customers.
                         We use a combination of advanced order routing technology, regular and
                          rigorous reviews of speed, execution quality, 
                        and price improvement to support our customers’ trading experience.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row mb50">
                        ...
                        <div class="feature-inner">
                            ...
                            <p>In Q4 of 2020 calendar year, Apex Holdings has delivered more than $25,979,702.55*
                                 of price improvement to our 
                                customers on market and marketable limit equity and options orders.</p>
                        </div>
                    </div>
                    ...
                    <div class="feature-box">
                        <div class="feature-inner">
                            <h3>$9.00*</h3>
                            <h4>Average price improvement per order filled</h4>
                            <p>All marketable and marketable limit option orders</p>
                        </div>
                    </div>
                    ...
                    <div class="feature-box">
                        <div class="feature-inner">
                            <h3>0.092 seconds*</h3>
                            <h4>Speed</h4>
                            <p>Covered market and marketable limit equity orders 100-1999 shares</p>
                        </div>
                    </div>
            ...
            <div class="row mb50">
                    ...
                    <div class="feature-box">
                        <div class="feature-inner">
                            ...
                            <p>The market centers to which Apex Holdings Securities routes its orders along with a discussion
                                 of the material aspects of each such relationship is available here.</p>
                                 </br>
                                 <i>*Statistics provided by S3 Matching Technologies LP, an independent company that is not affiliated
                                     with Apex Holdings Securities Inc. Data showed for Q4 2020 calendar year.</i>
                        </div>
                    </div>
