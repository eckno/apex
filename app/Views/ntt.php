...
<head>
    ...
    <title>New To Trading | Apex Holdings</title>
        ...
        <div class="hero-container container">
            <div class="hero-content">
                <div class="col-sm-12 m-auto text-center white">
                    <h3 class="h1-md mb10 text-uppercase">New To Trading</h3>
                    <h4 class="subheading">Learn/New To Trading</h4>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-md 4 col-sm-4">
                    <div class="service-box text-center">
                        ...
                        <div class="service-inner">
                            ...
                            <p></p>
                            <a href="ipo.php" class="read-more">View Topics</a>
                        </div>
                    </div>
                </div>
                <div class="col-md 4 col-sm-4">
                    <div class="service-box text-center active">
                        ...
                        <div class="service-inner">
                            ...
                            <p></p>
                            <a href="options.php" class="read-more">View Topics</a>
                        </div>
                    </div>
                </div>
                <div class="col-md 4 col-sm-4">
                    <div class="service-box text-center">
                        ...
                        <div class="service-inner ">
                            ...
                            <p></p>
                            <a href="stocks.php" class="read-more">View Topics</a>
                        </div>
                    </div>
                </div>
                <div class="col-md 4 col-sm-4">
                    <div class="service-box text-center">
                        ...
                        <div class="service-inner">
                            ...
                            <p></p>
                            <a href="etfs.php" class="read-more">View Topics</a>
                        </div>
                    </div>
                </div>
                <div class="col-md 4 col-sm-4">
                    <div class="service-box text-center active">
                        ...
                        <div class="service-inner">
                            <h4>Future Options <span></span></h4>
                            <p></p>
                            <a href="futuresopt.php" class="read-more">View Topics</a>
                        </div>
                    </div>
                </div>
                <div class="col-md 4 col-sm-4">
                    <div class="service-box text-center">
                        ...
                        <div class="service-inner">
                            <h4>cryptocurrencies<span></span></h4>
                            <p></p>
                            <a href="crypto.php" class="read-more">View Topics</a>
                        </div>
                    </div>
                </div>
            </div>
