...
<head>
    ...
    <title>Frequently Asked Questions | Apex Holdings</title>
        ...
        <div class="hero-container container">
            <div class="hero-content">
                <div class="col-sm-12 m-auto text-center white">
                    <h3 class="h1-md mb10 text-uppercase">Frequently Asked Questions</h3>
                    <h4 class="subheading">Learn/Frequently Asked Questions</h4>
                </div>
            </div>
        </div>
    </section>
